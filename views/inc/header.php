...
<body>
  ...
  <nav class="header">
    <div class="container nav__container">
      ...
      <a class="my-btn black mobile-dashboard" href="<?= LINK; ?>login">
                <img src="<?php if(isset($_SESSION['google-image'])){ echo $_SESSION['google-image']; }else{ ?><?=LINK;?>public/images/icon/dashboard.png<?php } ?>">
                <?= isset($_SESSION['loggedin']) ? 'Dashboard' : 'Login'; ?>
                </a>
      ...
      <ul class="nav__menu" class="slidebar">
        ...
        <li class="my-btn blue dashboard" style="border: 1px solid #ededed;background: white;color:black">
          <a class="dashboard-img-pc" style="color:black" href="<?= LINK; ?>login" alt="Dashboard user img">
            <img src="<?php if (isset($_SESSION['google-image'])) {
                        echo $_SESSION['google-image'];
                      } else { ?><?= LINK; ?>public/images/icon/dashboard.png<?php } ?>" alt="Dashboard user img">
            <?= isset($_SESSION['loggedin']) ? 'Dashboard' : 'Login'; ?>
          </a>
        </li>
      </ul>
